...
from clarity.ImageProcessing.GreyReconstruction import reconstruct
from clarity.ImageProcessing.Filter.StructureElement import structureElementOffsets
...
def findIntensity(img, centers, findIntensityParameter = None, method = "Max", size = (3,3,3), verbose = False, 
